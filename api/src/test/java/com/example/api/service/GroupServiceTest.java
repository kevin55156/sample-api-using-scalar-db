...
public class GroupServiceTest {
  ...
  private void setUp() throws TransactionException {
    groupService = new GroupService(groupRepository, userRepository, manager);
  ...
  @Test
  public void addGroupUser_shouldSuccess() throws TransactionException {
  ...
  @Test
  public void addGroupUser_alreadyBelongingUser_shouldThrowUserAlreadyBelongsException()
    ...
    Assertions.assertThrows(
        UserAlreadyBelongsException.class,
        () -> groupService.addGroupUser(MOCKED_GROUP_ID_1, groupUserDto));
    verify(tx).abort();
  }

  @Test
  public void deleteGroupUser_shouldSuccess() throws TransactionException {
    Group group = GroupStub.getGroup(MOCKED_GROUP_ID_1);
    User user = UserStub.getUser(MOCKED_USER_ID_1);
  ...
  @Test
  public void deleteGroupUser_NotBelongingUser_shouldThrowUserNotBelongException()
      throws TransactionException {
    Group group = GroupStub.getGroup(MOCKED_GROUP_ID_1);
    User user = UserStub.getUser(MOCKED_USER_ID_1);
    ...
    Assertions.assertThrows(
        UserNotBelongException.class,
        () -> groupService.deleteGroupUser(MOCKED_GROUP_ID_1, MOCKED_USER_ID_2));
    verify(tx).abort();
  }

  @Test
  public void listGroupUsers_shouldSuccess() throws TransactionException {
    Group group = GroupStub.getGroup(MOCKED_GROUP_ID_1);
